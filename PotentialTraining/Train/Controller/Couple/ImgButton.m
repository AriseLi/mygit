...
- (UIImageView *)bgImg{
    if (_bgImg == nil) {
        _bgImg = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, (kWMScreenWidth/2-100)/4, (kWMScreenWidth/2-100)/4)];
        _bgImg.backgroundColor = kWMRandomColor;
    }
    return _bgImg;
}
