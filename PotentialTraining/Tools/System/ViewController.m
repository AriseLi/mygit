...
#define kWMAutoSizeWidth(controlWidth) ((controlWidth) * kWMScreenWidth) / 1024
...
#define labelX kWMAutoSizeWidth(200)
#define labelY kWMAutoSizeWidth(200)

#import "ViewController.h"
#import "SchulteCollectCell.h"
...
- (void) layoutButton
{
    ...
    CGFloat labelWidth = (kWMScreenWidth - 400) / sqrt(self.count);
...
//    kWMLog(@"3.点击的数字是：%@", button.titleLabel.text);
...
//    kWMLog(@"DeviceOrientation：%ld", (long)[UIDevice currentDevice].orientation);
